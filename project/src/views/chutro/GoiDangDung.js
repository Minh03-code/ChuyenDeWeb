            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <span class="breadcrumb">
                  <a href="#">Chủ Trọ: </a>Nguyễn Gia Nghiêm{" "}
                </span>
              </div>
            </div>
          </div>
              ...
              <div class="col-lg-6 align-self-center">
                ...
                <div className="chitietgoidangki">
                  ...
                  <div className="chutro_info">
                    <b>Trạng Thái: </b> Chưa Xác Thực
                  </div>
                  <div className="chutro_info">
                    <b>Số Điện Thoại: </b>C111111111111
                  </div>
                  <div className="chutro_info">
                    <b>Số Tài Khoản:</b> 1111111111111
                  </div>
                  <div className="chutro_info">
                    <b>Số Tài Khoản Ngân Hàng:</b> 1111111111111
                  </div>
                  <div className="chutro_info">
                    <b>Tên Người Thụ Hưởng:</b> NGUYEN GIA NGHIEM
                  </div>
